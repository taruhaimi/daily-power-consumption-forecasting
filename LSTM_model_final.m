...
% Plots of the prediction:
    % figure; 
    % if dayInd == 1 || dayInd == 2 || dayInd == 3 || dayInd == 4|| dayInd == 5 || dayInd == 7|| dayInd == 14 || dayInd == 20|| dayInd == 30 || dayInd == 40 || dayInd == 50 || dayInd == 60
    %     nexttile;
    %     plot(dateTest(1:end-1),yTest(1:end-1));
    %     hold on 
    %     plot(dateTest(1:end-1),YPred(2:end));
